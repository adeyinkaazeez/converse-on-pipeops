...
def Create_Post(request):
    if request.method == 'POST':
       ...
       if form.is_valid():
          ...
          messages.success(request, 'Your Post has been successfully submitted as draft. If your post has followed laid down rules and regulations of Converse, the post shall be published in less than 30mins. Thanks')
          return redirect('crimes:create_post')
    else:
